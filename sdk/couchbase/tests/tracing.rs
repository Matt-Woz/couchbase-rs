...
#[test]
fn test_threshold_logging_layer() {
    run_test(async |_| {
        ...
        let threshold_logger = ThresholdLoggingLayer::new(Some(
            ThresholdLoggingOptions::new()
                .kv_threshold(Duration::from_millis(50))
                .query_threshold(Duration::from_millis(50))
                .analytics_threshold(Duration::from_millis(50))
                .search_threshold(Duration::from_millis(50))
                .analytics_threshold(Duration::from_millis(50))
                .management_threshold(Duration::from_millis(50))
        ...
        let span =
            info_span!(target: "couchbase::", "query_operation", db.couchbase.service = "query");
        sleep(Duration::from_millis(100)).await;
        drop(span);
        ...
        sleep(Duration::from_secs(2)).await; // Wait to ensure logger tick
